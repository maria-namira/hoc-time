[![Build status](https://ci.appveyor.com/api/projects/status/sfk9l1pbb8nwyl7q/branch/master?svg=true)](https://ci.appveyor.com/project/maria-namira/hoc-time/)

# Форматирование даты публикации

### Deployment:  <a href="https://github.com/maria-namira/hoc-time.git">Github Pages</a>
